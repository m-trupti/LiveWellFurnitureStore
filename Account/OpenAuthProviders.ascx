<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="LiveWell.Account.OpenAuthProviders" %>
...
<fieldset class="open-auth-providers">
    ...
    <asp:ListView runat="server" ID="providerDetails" ItemType="Microsoft.AspNet.Membership.OpenAuth.ProviderDetails"
        ...
        <EmptyDataTemplate>
            <div class="message-info">
                <p>There are no external authentication services available. </p>
            </div>
        </EmptyDataTemplate>
    </asp:ListView>
</fieldset>